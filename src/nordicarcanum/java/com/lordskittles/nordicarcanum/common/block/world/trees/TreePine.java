...
public class TreePine extends NordicTree {
    ...
    public static final TreeConfiguration CONFIG = (new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(Blocks.pine_log.get().getDefaultState()),
