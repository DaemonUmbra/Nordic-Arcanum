...
public class TreeJuniper extends NordicTree {
    ...
    public static final TreeConfiguration CONFIG = (new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(Blocks.juniper_log.get().getDefaultState()),
