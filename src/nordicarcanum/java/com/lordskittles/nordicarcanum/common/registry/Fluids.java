...
public class Fluids {
    ...
    public static final RegistryObject<FlowingFluid> liquid_arcanum_flowing = FLUIDS.register(NordicNames.LIQUID_ARCANUM + NordicNames.FLOWING, FluidArcanum.Flowing::new);
