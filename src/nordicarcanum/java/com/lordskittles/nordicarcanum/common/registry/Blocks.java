...
public class Blocks {
    ...
    public static final RegistryObject<Block> feldspar_brick_stairs = BLOCKS.register(NordicNames.FELDSPAR_BRICK + NordicNames.STAIRS_SUFFIX, () -> new BlockStairs(feldspar_brick_deco.get()));
    ...
    public static final RegistryObject<Block> infused_arcane_dust_compact = BLOCKS.register(NordicNames.INFUSED + NordicNames.ARCANE_DUST_COMPACT, () -> new BlockDecoration(AbstractBlock.Properties.from(arcane_dust_compact.get()), NordicItemGroup.INSTANCE));
    public static final RegistryObject<Block> infused_feldspar_brick = BLOCKS.register(NordicNames.INFUSED + NordicNames.FELDSPAR_BRICK, () -> new BlockDecoration(AbstractBlock.Properties.from(feldspar_brick_deco.get()), NordicItemGroup.INSTANCE));
