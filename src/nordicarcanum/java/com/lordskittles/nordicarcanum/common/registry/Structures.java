...
public class Structures {
    ...
    public static final RegistryObject<StructureAncientTemple> ancient_temple = registerStructure(NordicNames.ANCIENT_TEMPLE + NordicNames.STRUCTURE_SUFFIX, new StructureAncientTemple(NoFeatureConfig.CODEC));
    public static final RegistryObject<StructureShrine> shrine = registerStructure(NordicNames.SHRINE + NordicNames.STRUCTURE_SUFFIX, new StructureShrine(NoFeatureConfig.CODEC));

    //Structure Pieces
    public static IStructurePieceType pillar_piece = NordicPillarPieces.Piece::new;
    public static IStructurePieceType temple_piece = AncientTemplePieces.Piece::new;
    ...
    public static StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> temple_feature;
    public static StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> shrine_feature;
    ...
    public static void registerFeatures() {
        ...
        temple_feature = register(NordicNames.ANCIENT_TEMPLE + NordicNames.STRUCTURE_SUFFIX + "_feature", ancient_temple.get().withConfiguration(NoFeatureConfig.INSTANCE));
        shrine_feature = register(NordicNames.SHRINE + NordicNames.STRUCTURE_SUFFIX + "_feature", shrine.get().withConfiguration(NoFeatureConfig.INSTANCE));
    }
