...
public class TranslucentColoredParticle extends SpriteTexturedParticle {

    private ArcaneRenderer.DVector3 pos;

    public TranslucentColoredParticle(ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, TranslucentColoredParticleData data, IAnimatedSprite sprite) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Factory implements IParticleFactory<TranslucentColoredParticleData> {
        ...
        @Nullable
        @Override
        public Particle makeParticle(TranslucentColoredParticleData type, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {

            TranslucentColoredParticle particle = new TranslucentColoredParticle(world, x, y, z, xSpeed, ySpeed, zSpeed, type, this.spriteSet);
