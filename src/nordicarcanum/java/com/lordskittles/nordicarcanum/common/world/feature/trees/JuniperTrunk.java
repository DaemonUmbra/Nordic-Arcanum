...
public class JuniperTrunk extends TrunkPlacerBase {
    ...
    public static final Codec<JuniperTrunk> codec = RecordCodecBuilder.create((trunkInstance) -> {
        return trunkPlacerParts(trunkInstance).apply(trunkInstance, JuniperTrunk::new);
    });
